...
Source: https://jsunpack-n.googlecode.com/svn/trunk/swf.py
Licensed under GPLv2, see: https://code.google.com/p/jsunpack-n/source/browse/trunk/COPYING
...
def swfstream(data):
	...
	try:
		...
		if data.startswith('FWS'):
			...
			out += 'processing flash file [version %d] (length %d, actual length %d)\n' % (version, entirelen, len(data))
