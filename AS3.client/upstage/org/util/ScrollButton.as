package org.util {
    ...
    */
    ...
    public class ScrollButton extends ButtonMc 
    {
                                       ...
                                       scale : Number, offX : Number, offY : Number) :ScrollButton
        {
            ...
            var sb: ScrollButton = new ScrollButton();
            sb.draw(ScrollButton.drawer, ScrollButton.buttonPoints,
                    sb.lineColour, sb.fillColour, offX, offY, scale);
         ...
         * @brief scroll up. 
         *
        override function onPress() :void
        {
            this.action();
